...
export default function Attendance() {
  return (
    <Link href="/student/attendance" className="group bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md transition-shadow">
      ...
      <p className="text-sm font-semibold text-gray-700">Mark your attendance</p>
      <p className="text-xs text-gray-400 mt-1">Tap to view active sessions and check in.</p>
    </Link>
  );
}
