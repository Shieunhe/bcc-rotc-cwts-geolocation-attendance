...
export default function RotcLoginForm() {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-gray-200 text-base leading-relaxed drop-shadow-md">
            Buenavista Community College&apos;s ROTC management system for enrollment, attendance tracking, and student records.
          </p>
              ...
              <>
                <div className="mb-7">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-gray-900">ROTC Admin</h2>
                      <p className="text-sm text-gray-500">Sign in to access the ROTC dashboard</p>
                    </div>
                  </div>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <PrimaryButton
                    type="submit"
                    loading={loading}
                    className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 active:from-red-800 active:to-red-900 shadow-red-200/50 hover:shadow-red-200/60"
                  >
                    Sign In
                  </PrimaryButton>
                </form>
