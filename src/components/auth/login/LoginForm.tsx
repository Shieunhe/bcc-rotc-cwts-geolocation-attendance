...
function PrimaryButton({
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 active:from-blue-800 active:to-blue-900 text-white text-sm font-semibold rounded-xl shadow-lg shadow-blue-200/50 hover:shadow-xl hover:shadow-blue-200/60 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed disabled:shadow-none cursor-pointer"
      {...props}
    >
      {loading ? (
        <>
...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel with ROTC image - hidden on mobile */}
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 overflow-hidden">
        {/* Background image */}
        <img
          src="/image/rotc-login-display.jpg"
          alt="BCC ROTC Unit"
